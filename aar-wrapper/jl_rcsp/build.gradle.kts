...
val artifactIdValue = "jl_rcsp"
val aarFile = layout.projectDirectory.file("libs/jl_rcsp_V0.8.0_705-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jl_rcsp Android SDK")
                description.set("Closed-source jl_rcsp AAR SDK.")
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jl_rcsp")
                    connection.set("scm:git:https://www.caitun.com/scm/jl_rcsp.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jl_rcsp.git")
                }
