    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jl_bluetooth_rcsp")
                    connection.set("scm:git:https://www.caitun.com/scm/jl_bluetooth_rcsp.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jl_bluetooth_rcsp.git")
                }
