...
val artifactIdValue = "jl_bluetooth_connect"
val aarFile = layout.projectDirectory.file("libs/jl_bluetooth_connect_V2.0.0_10703-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jl_bluetooth_connect Android SDK")
                description.set("Closed-source jl_bluetooth_connect AAR SDK.")
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jl_bluetooth_connect")
                    connection.set("scm:git:https://www.caitun.com/scm/jl_bluetooth_connect.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jl_bluetooth_connect.git")
                }
