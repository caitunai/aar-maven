...
val artifactIdValue = "jldecryption"
val aarFile = layout.projectDirectory.file("libs/jldecryption_v0.4-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jldecryption Android SDK")
                description.set("Closed-source jldecryption AAR SDK.")
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jldecryption")
                    connection.set("scm:git:https://www.caitun.com/scm/jldecryption.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jldecryption.git")
                }
