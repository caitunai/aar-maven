...
version = "1.14.0_11307"

val artifactIdValue = "jl_watch"
val aarFile = layout.projectDirectory.file("libs/JL_Watch_V1.14.0_11307-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jl_watch Android SDK")
                description.set("Closed-source jl_watch AAR SDK.")
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jl_watch")
                    connection.set("scm:git:https://www.caitun.com/scm/jl_watch.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jl_watch.git")
                }
