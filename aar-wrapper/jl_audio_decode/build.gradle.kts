...
val artifactIdValue = "jl_audio_decode"
val aarFile = layout.projectDirectory.file("libs/jl_audio_decode_V2.1.0_20012-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jl_audio_decode Android SDK")
                description.set("Closed-source jl_audio_decode AAR SDK.")
                ...
                scm {
                    url.set("https://www.caitun.com/scm/jl_audio_decode")
                    connection.set("scm:git:https://www.caitun.com/scm/jl_audio_decode.git")
                    developerConnection.set("scm:git:https://www.caitun.com/scm/jl_audio_decode.git")
                }
