...
version = "1.11.0_11015"

val artifactIdValue = "jl_bt_ota"
val aarFile = layout.projectDirectory.file("libs/jl_bt_ota_V1.11.0_11015-release.aar")
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                name.set("jl_bt_ota Android SDK")
                description.set("Closed-source jl_bt_ota AAR SDK.")
